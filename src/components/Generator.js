    ...
    return (
      <div className="Generator App">
        ...
        <header>
          ...
          <h2>Create a really cool color map that shows how long it will take to drive from an origin point – like your apartment or a prospective home – to surrounding areas in different traffic conditions.</h2>
